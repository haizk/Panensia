        ...
        <div class="container">
            ...
            <div class="row align-items-center logodata owl-carousel owl-theme">
                <div class="col-xl-12 item">
                    <div class="logo-img">
                        <img alt="logo-img" src="https://via.placeholder.com/140x124">
                        <h5>Kings Arms</h5>
                    </div>
                </div>
                <div class="col-xl-12 item">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-12">
                    <div class="good-taste">
                        <h2>Service shows good taste.</h2>
                        <p>Enim lobortis scelerisque fermentum dui faucibus. Tempor commodo ullamcorper a lacus vestibulum
                            sed arcu non.</p>
                    </div>
                </div>
                <div class="col-xl-8 col-lg-12">
                    <div class="comment-data comment-slide owl-carousel owl-theme">
                        <div class="author-text item">
                            <p>
                                "Tortor vitae purus faucibus ornare suspendisse. Ut porttitor leo a diam. Massa tincidunt
                                nunc pulvinar sapien et ligula ullamcorper malesuada proin. Ut tortor pretium viverra
                                suspendisse".</p>
                            <div class="thomas">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="get-the-menu">
                        <h2 data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">Get the menu of your favorite
                            restaurants every day</h2>
