                ...
                <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="about-text">
                        <ul class="crumbs d-flex">
                            ...
                            <li class="two"><a href="index.html"><i class="fa-solid fa-right-long"></i>The Wilmington</a>
                            </li>
                        </ul>
                        <div class="logo-detail">
                            <img alt="logo" src="https://via.placeholder.com/80x80">
                        ...
                        <div class="rate">
                            ...
                            <span>FEATURES:</span>
                            <p>Lorem mollis aliquam ut porttitor. Nisl rhoncus mattis rhoncus urna neque. Pharetra sit amet
                                aliquam id. Urna nec tincidunt praesent semper feugiat nibh.</p>
                        </div>
                        ...
                        <div class="Provides" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
                            ...
                            <div class="nav nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <button class="nav-link active" id="v-pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-controls="v-pills-home" aria-selected="true">Breakfast</button>
