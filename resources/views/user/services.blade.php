            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12" data-aos="fade-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="about-text">
                        ...
                        <h2>Service shows
                            good taste</h2>
                        <p>Mauris nunc congue nisi vitae suscipit tellus mauris. Ac tincidunt vitae semper quis lectus.
                            Sollicitudin ac orci phasellus egestas tellus.</p>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-12" data-aos="flip-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="services-info">
                        ...
                        <p>Risus quis varius quam quisque id diam vel quam elementum. Luctus venenatis lectus magna
                            fringilla urna porttitor rhoncus dolor. Mauris pharetra et ultrices neque. Id ornare arcu odio
                            ut sem. Sed vulputate mi sit amet mauris.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6" data-aos="flip-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="services-card-style">
                        ...
                        <h4><a href="#">Save<br>
                                Your Time</a></h4>
                        <p>Turpis cursus in hac habitasse platea. Magna fringilla urna porttitor dolor purus non enim.
                            Molestie nunc non blandit.</p>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6" data-aos="flip-up" data-aos-delay="400" data-aos-duration="500">
                    <div class="services-card-style">
                        ...
                        <h4><a href="#">Variety<br>
                                Food</a></h4>
                        <p>Tempor orci dapibus ultrices in iaculis nunc sed augue. Sed euismod nisi porta lorem mollis
                            aliquam ut porttitor leo.</p>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6" data-aos="flip-up" data-aos-delay="700" data-aos-duration="800">
                    <div class="services-card-style">
                        ...
                        <h4><a href="#">Regular<br>
                                Discounts</a></h4>
                        <p>Morbi leo urna molestie at elementum eu facilisis sed odio. Mattis nunc sed blandit libero
                            volutpat sed cras ornare.</p>
                    </div>
                </div>
            ...
            <div class="row ">
                <div class="col-lg-4" data-aos="flip-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="work-card service">
                        ...
                        <p>Non enim praesent elementum facilisis leo vel fringilla. Lectus proin nibh nisl condimentum id.
                ...
                <div class="col-lg-4" data-aos="flip-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="work-card service">
                        <img alt="img" src="https://via.placeholder.com/300x154">
                        <h4>Select menu</h4>
                        <p>Eu mi bibendum neque egestas congue quisque. Nulla facilisi morbi tempus iaculis urna id volutpat
                            lacus. Odio ut sem nulla </p>
                    </div>
                </div>
                <div class="col-lg-4" data-aos="flip-up" data-aos-delay="500" data-aos-duration="600">
                    <div class="work-card service">
                        ...
                        <p>Nunc lobortis mattis aliquam faucibus. Nibh ipsum consequat nisl vel pretium lectus quam id leo.
                            A scelerisque purus semper eget.</p>
                    </div>
                </div>
            </div>
        </div>
