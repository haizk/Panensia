...
@section('content')
    <!-- hero-section -->
    <section class="hero-section about blog-page gap" style="background-image: url(https://via.placeholder.com/1920x628);">
        <div class="container">
                ...
                <div class="offset-xl-1 col-lg-5" data-aos="flip-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="benefit-text">
                        <h2>Benefits you get with
                            Quickeat</h2>
                        <p>Suspendisse in est ante in. Duis at consectetur lorem donec massa. Eget lorem dolor sed viverra
                            ipsum. Aliquam id diam maecenas ultricies mi. Nulla facilisi morbi tempus iaculis.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="team-description">
                        ...
                        <p>Consequat semper viverra nam libero justo laoreet sit. Consequat semper viverra nam libero justo
                            laoreet sit amet cursus. Morbi tincidunt ornare .</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="team-description">
                        ...
                        <p>Maecenas ultricies mi eget mauris pharetra. Sed ullamcorper morbi tincidunt ornare massa eget.
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="400" data-aos-duration="500">
                    <div class="team-description">
                        ...
                        <p>Dignissim cras tincidunt lobortis feugiat vivamus at augue eget. Cursus risus at ultrices mi
                            tempus imperdiet. Non diam phasellus vestibulum.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="team-description end">
                        <h4><i class="fa-solid fa-money-bill-1-wave"></i>Stable Income</h4>
                        <p>Dui sapien eget mi proin sed. Nibh nisl condimentum id venenatis a. Vulputate eu scelerisque
                ...
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="team-description end">
                        ...
                        <p>Euismod quis viverra nibh cras pulvinar mattis nunc sed blandit. Neque viverra justo nec ultrices
                            dui sapien. Volutpat est velit egestas.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="400" data-aos-duration="500">
                    <div class="team-description end">
                        <h4><i class="fa-solid fa-folder-open"></i>Full Insurance</h4>
                        <p>Cras semper auctor neque vitae tempus quam. Sed viverra tellus in hac habitasse platea. Sagittis
                            aliquam malesuada bibendum arcu vitae.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="flip-up" data-aos-delay="200" data-aos-duration="300">
                    <div class="join-img-blog">
                        <img alt="join" src="https://via.placeholder.com/641x453">
                    </div>
                </div>
                <div class="offset-xl-1 col-lg-5" data-aos="flip-up" data-aos-delay="300" data-aos-duration="400">
                    <div class="join-the">
                        <h2>Frequently asked questions</h2>
                        <p>Ultricies lacus sed turpis tincidunt id aliquet risus feugiat. Mauris augue neque gravida in
                            fermentum et sollicitudin. Amet est placerat in egestas erat imperdiet.</p>
                    </div>
                    <div class="counter-blog">
                        <div class="counter-img-data">
                            <h2>74</h2>
                            <span>Couriers <br>in Your city</span>
                        </div>
                        <div class="counter-img-data">
                            <h2>12</h2>
            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="300"
                    ...
                    <div class="news-posts-one blog">
                        ...
                        <p>Nec tincidunt praesent semper feugiat nibh. Feugiat in ante metus dictum. Sapien nec sagittis
                            aliquam malesuada bibendum arcu vitae. Non enim praesent elementum facilisis...</p>
                        <a href="#">Read More<i class="fa-solid fa-arrow-right"></i></a>
                        <ul class="data">
                            <li>
                                <h6><i class="fa-solid fa-user"></i>by Quickeat</h6>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12" data-aos="flip-up" data-aos-delay="400"
                    ...
                    <div class="news-posts-one blog">
                        ...
                        <p>Pulvinar neque laoreet suspendisse interdum consectetur libero id faucibus nisl. Aliquam ultrices
                            sagittis orci a scelerisque purus semper eget duis. Viverra vitae congue eu consequat...</p>
                        <a href="#">Read More<i class="fa-solid fa-arrow-right"></i></a>
                        <ul class="data">
                            <li>
                                <h6><i class="fa-solid fa-user"></i>by Quickeat</h6>
                ...
                <div class="button-gap" data-aos="fade-up" data-aos-delay="300" data-aos-duration="400">
