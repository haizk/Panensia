                    ...
                    <tbody class="list" id="staff02">
                        <template v-if="products.length > 0">
                            <tr v-for="(item, index) in products" :key="item.id">
                                ...
                                <td>
                                  <span class="badge badge-warning">{{ item.product_category.name }}</span>
                                </td>
                                ...
                                <td>
                                    ...
                                    <RouterLink :to="{ name: 'admin.product_images', params: { id: item.id } }">
                                        <button class="btn btn-info mr-1"> <i class="fa fa-images"></i></button>
                                    </RouterLink>
                                    <button class="btn btn-danger" @click="deleteProduct(item.id)"><i class="fa fa-times"></i></button>
                                </td>
                            </tr>
                        </template>
                        <template v-else>
