...
<template>
    <main>
                    ...
                    >
                        ...
                        <div class="container position-relative holder pt-xl-10 pt-0">
                            ...
                            <div class="row">
                                ...
                                <div class="imgHolder">
                                    <img
                                        src="https://i.ibb.co/2tGgsZD/chili-pepper-spices-2023-11-27-05-01-26-utc.jpg"
        ...
        <!-- dealSecHolder -->
        <section
            class="dealSecHolder container-fluid overflow-hidden py-xl-12 py-lg-10 py-md-8 py-5"
        >
            <!-- mainHeader -->
            <header class="col-12 mainHeader mb-7 text-center">
                <span class="headerBorder d-block mb-md-5 mb-3"
                    ><img
                        src="https://www.panensia.co.id/wp-content/uploads/2023/11/logo-panensia-rev.png"
                        alt="Header Border"
                    ...
                    <div class="featureCol position-relative w-100 px-3 mb-sm-8 mb-6">
                        <div class="border">
                            <div class="imgHolder position-relative w-100 overflow-hidden">
                                <img
                                    src="https://www.panensia.co.id/wp-content/uploads/2023/10/cengkeh-600x600.jpg"
                                    alt="image description"
                            ...
                            <div class="text-center py-5 px-2">
                                <span class="title d-block mb-2"
                                    ><a href="shop-detail.html">Sint Incidunt Utlabore</a></span
                                >
                                ...
                                >
                                <span
                                    class="hotOffer green fwEbold text-uppercase text-white position-absolute d-block"
                                    >Sale</span
                                >
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <div class="featureCol px-3 w-100 mb-sm-8 mb-6">
                        <div class="border">
                            ...
                            <div class="text-center py-5 px-2">
                                <span class="title d-block mb-2"
                                    ><a href="shop-detail.html">Cengkeh</a></span
                                >
